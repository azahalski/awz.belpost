...
class Handler extends \Bitrix\Sale\Delivery\Services\Base {
    ...
    {
        return Loc::getMessage('AWZ_BELPOST_HANDLER_NAME');
    }

    public static function getClassDescription()
    {
        return Loc::getMessage('AWZ_BELPOST_HANDLER_DESC');
    }
    ...
    {
        return array(
            'Awz\Belpost\Profiles\Pickup',
            //'Awz\Belpost\Profiles\Standart',
        );
    }
    ...
    {
        throw new \Bitrix\Main\SystemException(Loc::getMessage('AWZ_BELPOST_HANDLER_NOPROFILE'));
    }
