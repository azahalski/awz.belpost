...
Модуль интеграции службы доставки "Белпочта" для Bitrix CMS. Позволяет автоматизировать работу с пунктами самовывоза (ПВЗ), рассчитывать стоимость доставки и управлять настройками доставки через админпанель.
